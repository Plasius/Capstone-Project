...
public class TaskListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static String TAG_AUTH = "AUTH";
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            ((TextView)findViewById(R.id.hello)).setText(user.getDisplayName());
                            Toast.makeText(TaskListActivity.this, "Welcom to firebase!", Toast.LENGTH_SHORT).show();
                        } else {
                            // If sign in fails, display a message to the user.
                            Log.w("AUTH", "signInWithCredential:failure", task.getException());
                            Toast.makeText(TaskListActivity.this, "Auth failed", Toast.LENGTH_SHORT).show();
                        }
